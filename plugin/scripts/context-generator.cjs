"use strict";var It=Object.create;var X=Object.defineProperty;var Lt=Object.getOwnPropertyDescriptor;var Mt=Object.getOwnPropertyNames;var Dt=Object.getPrototypeOf,vt=Object.prototype.hasOwnProperty;var yt=(n,e)=>{for(var t in e)X(n,t,{get:e[t],enumerable:!0})},Te=(n,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of Mt(e))!vt.call(n,r)&&r!==t&&X(n,r,{get:()=>e[r],enumerable:!(s=Lt(e,r))||s.enumerable});return n};var y=(n,e,t)=>(t=n!=null?It(Dt(n)):{},Te(e||!n||!n.__esModule?X(t,"default",{value:n,enumerable:!0}):t,n)),Ut=n=>Te(X({},"__esModule",{value:!0}),n);var Zt={};yt(Zt,{generateContext:()=>Ee});module.exports=Ut(Zt);var Ot=y(require("path"),1),Rt=require("os"),Nt=require("fs");var Ce=require("bun:sqlite");var h=require("path"),te=require("os"),H=require("fs");var he=require("url");var L=require("fs"),U=require("path"),Se=require("os"),Z=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Z||{}),fe=(0,U.join)((0,Se.homedir)(),".claude-mem"),ee=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;logFileDate=null;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){let e=new Date().toISOString().split("T")[0];if(!(this.logFileInitialized&&this.logFileDate===e)){this.logFileInitialized=!0,this.logFileDate=e;try{let t=(0,U.join)(fe,"logs");(0,L.existsSync)(t)||(0,L.mkdirSync)(t,{recursive:!0}),this.logFilePath=(0,U.join)(t,`claude-mem-${e}.log`)}catch(t){console.error("[LOGGER] Failed to initialize log file:",t),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,U.join)(fe,"settings.json");if((0,L.existsSync)(e)){let t=(0,L.readFileSync)(e,"utf-8"),r=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=Z[r]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):_=" "+this.formatData(o));let m="";if(r){let{sessionId:g,memorySessionId:S,correlationId:b,...p}=r;Object.keys(p).length>0&&(m=` {${Object.entries(p).map(([T,f])=>`${T}=${f}`).join(", ")}}`)}let E=`[${i}] [${a}] [${d}] ${c}${s}${m}${_}`;if(this.logFilePath)try{(0,L.appendFileSync)(this.logFilePath,E+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),_=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",m={...s,location:_};return this.warn(e,`[HAPPY-PATH] ${t}`,m,r),o}},l=new ee;var Ft={};function xt(){return typeof __dirname<"u"?__dirname:(0,h.dirname)((0,he.fileURLToPath)(Ft.url))}var kt=xt();function $t(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let n=(0,h.join)((0,te.homedir)(),".claude-mem"),e=(0,h.join)(n,"settings.json");try{if((0,H.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),r=s.env??s;if(r.CLAUDE_MEM_DATA_DIR)return r.CLAUDE_MEM_DATA_DIR}}catch{}return n}var C=$t(),D=process.env.CLAUDE_CONFIG_DIR||(0,h.join)((0,te.homedir)(),".claude"),ns=(0,h.join)(D,"plugins","marketplaces","thedotmack"),os=(0,h.join)(C,"archives"),is=(0,h.join)(C,"logs"),as=(0,h.join)(C,"trash"),ds=(0,h.join)(C,"backups"),us=(0,h.join)(C,"modes"),cs=(0,h.join)(C,"settings.json"),be=(0,h.join)(C,"claude-mem.db"),_s=(0,h.join)(C,"vector-db"),ls=(0,h.join)(C,"observer-sessions"),ms=(0,h.join)(D,"settings.json"),ps=(0,h.join)(D,"commands"),Es=(0,h.join)(D,"CLAUDE.md");function Ae(n){(0,H.mkdirSync)(n,{recursive:!0})}function Oe(){return(0,h.join)(kt,"..")}var Re=require("crypto");var wt=3e4;function j(n,e,t){return(0,Re.createHash)("sha256").update([n||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function G(n,e,t,s){let r=t-wt;return n.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ? AND node IS ?").get(e,r,s??null)}function se(n){if(!n)return[];try{let e=JSON.parse(n);return Array.isArray(e)?e:[String(e)]}catch{return[n]}}var A="claude";function Pt(n){return n.trim().toLowerCase().replace(/\s+/g,"-")}function v(n){if(!n)return A;let e=Pt(n);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:A}function Ne(n){let e=["claude","codex","cursor"];return[...n].sort((t,s)=>{let r=e.indexOf(t),o=e.indexOf(s);return r!==-1||o!==-1?r===-1?1:o===-1?-1:r-o:t.localeCompare(s)})}function Xt(n,e){return{customTitle:n,platformSource:e?v(e):void 0}}var B=class{db;_currentNode=null;_currentPlatform=null;_currentInstance=null;_currentLlmSource=null;setLocalProvenance(e,t,s,r){this._currentNode=e,this._currentPlatform=t,this._currentInstance=s,this._currentLlmSource=r??null}constructor(e=be){e!==":memory:"&&Ae(C),this.db=new Ce.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.addObservationProvenanceColumns(),this.addSummaryProvenanceColumns()}initializeSchema(){this.db.run(`
    ...
    `),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_session ON pending_messages(session_db_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_status ON pending_messages(status)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_pending_messages_claude_session ON pending_messages(content_session_id)"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(16,new Date().toISOString()),l.debug("DB","pending_messages table created successfully")}renameSessionIdColumns(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(17))return;l.debug("DB","Checking session ID columns for semantic clarity rename");let t=0,s=(r,o,i)=>{let a=this.db.query(`PRAGMA table_info(${r})`).all(),d=a.some(_=>_.name===o);return a.some(_=>_.name===i)?!1:d?(this.db.run(`ALTER TABLE ${r} RENAME COLUMN ${o} TO ${i}`),l.debug("DB",`Renamed ${r}.${o} to ${i}`),!0):(l.warn("DB",`Column ${o} not found in ${r}, skipping rename`),!1)};s("sdk_sessions","claude_session_id","content_session_id")&&t++,s("sdk_sessions","sdk_session_id","memory_session_id")&&t++,s("pending_messages","claude_session_id","content_session_id")&&t++,s("observations","sdk_session_id","memory_session_id")&&t++,s("session_summaries","sdk_session_id","memory_session_id")&&t++,s("user_prompts","claude_session_id","content_session_id")&&t++,this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(17,new Date().toISOString()),t>0?l.debug("DB",`Successfully renamed ${t} session ID columns`):l.debug("DB","No session ID column renames needed (already up to date)")}repairSessionIdColumnRename(){this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(19)||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(19,new Date().toISOString())}addFailedAtEpochColumn(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(20))return;this.db.query("PRAGMA table_info(pending_messages)").all().some(r=>r.name==="failed_at_epoch")||(this.db.run("ALTER TABLE pending_messages ADD COLUMN failed_at_epoch INTEGER"),l.debug("DB","Added failed_at_epoch column to pending_messages table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(20,new Date().toISOString())}addOnUpdateCascadeToForeignKeys(){if(!this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(21)){l.debug("DB","Adding ON UPDATE CASCADE to FK constraints on observations and session_summaries"),this.db.run("PRAGMA foreign_keys = OFF"),this.db.run("BEGIN TRANSACTION");try{this.db.run("DROP TRIGGER IF EXISTS observations_ai"),this.db.run("DROP TRIGGER IF EXISTS observations_ad"),this.db.run("DROP TRIGGER IF EXISTS observations_au"),this.db.run("DROP TABLE IF EXISTS observations_new");let t=new Set(this.db.prepare("PRAGMA table_info(observations)").all().map(p=>p.name)),s=[],r=[];t.has("content_hash")&&(s.push("content_hash TEXT"),r.push("content_hash")),t.has("node")&&(s.push("node TEXT"),r.push("node")),t.has("platform")&&(s.push("platform TEXT"),r.push("platform")),t.has("instance")&&(s.push("instance TEXT"),r.push("instance")),t.has("llm_source")&&(s.push("llm_source TEXT"),r.push("llm_source")),t.has("generated_by_model")&&(s.push("generated_by_model TEXT"),r.push("generated_by_model")),t.has("relevance_count")&&(s.push("relevance_count INTEGER DEFAULT 0"),r.push("relevance_count"));let o=s.length>0?`,
      ...
      `),this.db.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='observations_fts'").all().length>0&&this.db.run(`
          ...
          CREATE TRIGGER IF NOT EXISTS observations_au AFTER UPDATE ON observations BEGIN
            ...
            VALUES (new.id, new.title, new.subtitle, new.narrative, new.text, new.facts, new.concepts);
          END;
        `),this.db.run("DROP TABLE IF EXISTS session_summaries_new");let c=new Set(this.db.prepare("PRAGMA table_info(session_summaries)").all().map(p=>p.name)),_=[],m=[];c.has("node")&&(_.push("node TEXT"),m.push("node")),c.has("platform")&&(_.push("platform TEXT"),m.push("platform")),c.has("instance")&&(_.push("instance TEXT"),m.push("instance")),c.has("llm_source")&&(_.push("llm_source TEXT"),m.push("llm_source"));let E=_.length>0?`,
          ${_.join(`,
          `)}`:"",g="id, memory_session_id, project, request, investigated, learned, completed, next_steps, files_read, files_edited, notes, prompt_number, discovery_tokens, created_at, created_at_epoch",S=m.length>0?`${g}, ${m.join(", ")}`:g;this.db.run(`
        CREATE TABLE session_summaries_new (
          id INTEGER PRIMARY KEY AUTOINCREMENT,
          memory_session_id TEXT NOT NULL,
          project TEXT NOT NULL,
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:r,project:o,type:i,concepts:a,files:d}=t,c=s==="date_asc"?"ASC":"DESC",_=r?`LIMIT ${r}`:"",m=e.map(()=>"?").join(","),E=[...e],g=[];if(o&&(g.push("project = ?"),E.push(o)),i)if(Array.isArray(i)){let p=i.map(()=>"?").join(",");g.push(`type IN (${p})`),E.push(...i)}else g.push("type = ?"),E.push(i);if(a){let p=Array.isArray(a)?a:[a],R=p.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");E.push(...p),g.push(`(${R.join(" OR ")})`)}if(d){let p=Array.isArray(d)?d:[d],R=p.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");p.forEach(T=>{E.push(`%${T}%`,`%${T}%`)}),g.push(`(${R.join(" OR ")})`)}let S=g.length>0?`WHERE id IN (${m}) AND ${g.join(" AND ")}`:`WHERE id IN (${m})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${S}
    ...
    `).run(e,t,s,d.toISOString(),c,r||(this._currentNode??null),o||(this._currentPlatform??null),i||(this._currentInstance??null),a||(this._currentLlmSource??null)).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,r,o=0,i,a,d,c,_,m){let E=i??Date.now(),g=new Date(E).toISOString(),S=j(e,s.title,s.narrative),b=G(this.db,S,E,d);if(b)return{id:b.id,createdAtEpoch:b.created_at_epoch};let R=this.db.prepare(`
      INSERT INTO observations
      (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
       files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
       generated_by_model, node, platform, instance, llm_source)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),r||null,o,S,g,E,a||null,d||null,c||null,_||null,m||null);return{id:Number(R.lastInsertRowid),createdAtEpoch:E}}storeSummary(e,t,s,r,o=0,i,a,d,c,_){let m=i??Date.now(),E=new Date(m).toISOString(),S=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch,
       node, platform, instance, llm_source)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,r||null,o,E,m,a??null,d??null,c??null,_??null);return{id:Number(S.lastInsertRowid),createdAtEpoch:m}}storeObservations(e,t,s,r,o,i=0,a,d,c,_,m,E){let g=a??Date.now(),S=new Date(g).toISOString();return this.db.transaction(()=>{let p=[],R=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
         generated_by_model, node, platform, instance, llm_source)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let f of s){let M=j(e,f.title,f.narrative),Q=G(this.db,M,g,c);if(Q){p.push(Q.id);continue}let N=R.run(e,t,f.type,f.title,f.subtitle,JSON.stringify(f.facts),f.narrative,JSON.stringify(f.concepts),JSON.stringify(f.files_read),JSON.stringify(f.files_modified),o||null,i,M,S,g,d||null,c??null,_??null,m??null,E??null);p.push(Number(N.lastInsertRowid))}let T=null;if(r){let M=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch,
           node, platform, instance, llm_source)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,r.request,r.investigated,r.learned,r.completed,r.next_steps,r.notes,o||null,i,S,g,c??null,_??null,m??null,E??null);T=Number(M.lastInsertRowid)}return{observationIds:p,summaryId:T,createdAtEpoch:g}})()}storeObservationsAndMarkComplete(e,t,s,r,o,i,a,d=0,c,_,m,E,g,S){let b=c??Date.now(),p=new Date(b).toISOString();return this.db.transaction(()=>{let T=[],f=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
         generated_by_model, node, platform, instance, llm_source)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let N of s){let P=j(e,N.title,N.narrative),ge=G(this.db,P,b,m);if(ge){T.push(ge.id);continue}let Ct=f.run(e,t,N.type,N.title,N.subtitle,JSON.stringify(N.facts),N.narrative,JSON.stringify(N.concepts),JSON.stringify(N.files_read),JSON.stringify(N.files_modified),a||null,d,P,p,b,_||null,m??null,E??null,g??null,S??null);T.push(Number(Ct.lastInsertRowid))}let M;if(r){let P=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch,
           node, platform, instance, llm_source)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,r.request,r.investigated,r.learned,r.completed,r.next_steps,r.notes,a||null,d,p,b,m??null,E??null,g??null,S??null);M=Number(P.lastInsertRowid)}return this.db.prepare(`
    ...
    `).get(e)||null}getOrCreateManualSession(e){let t=`manual-${e}`,s=`manual-content-${e}`;if(this.db.prepare("SELECT memory_session_id FROM sdk_sessions WHERE memory_session_id = ?").get(t))return t;let o=new Date;return this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, 'active')
    `).run(t,s,e,A,o.toISOString(),o.getTime()),l.info("SESSION","Created manual session",{memorySessionId:t,project:e}),t}close(){this.db.close()}importSdkSession(e){let t=this.db.prepare("SELECT id FROM sdk_sessions WHERE content_session_id = ?").get(e.content_session_id);return t?{imported:!1,id:t.id}:{imported:!0,id:this.db.prepare(`
      INSERT INTO sdk_sessions (
